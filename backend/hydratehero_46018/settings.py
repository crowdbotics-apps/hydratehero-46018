"""
Django settings for hydratehero_46018 project.
...
ROOT_URLCONF = 'hydratehero_46018.urls'
...
WSGI_APPLICATION = 'hydratehero_46018.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hydratehero_46018 API",
    "DESCRIPTION": "API documentation for hydratehero_46018 App",
    "VERSION": "v1",
}
